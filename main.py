...
if __name__ == "__main__":
    ...
    evaluate_model_and_generate_results('numerical_experiments/Part1_power_method/pmnn_MLP_2D_d4_w20_epochs50000/',True)
    ...
    evaluate_model_and_generate_results('numerical_experiments/Part4_architectures/pmnn_MLP_2D_d4_w20_epochs50000/',True)
