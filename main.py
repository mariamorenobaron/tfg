...
if __name__ == "__main__":
    ...
    generate_plots_from_training_and_push('numerical_experiments/Part1_power_method/pmnn_MLP_5D_d4_w20/' ,push_to_git= True)
    evaluate_model_and_generate_results('numerical_experiments/Part1_power_method/pmnn_MLP_5D_d4_w20/',50000, push_to_git=True)
