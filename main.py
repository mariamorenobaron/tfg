...
if __name__ == "__main__":
    ...
    generate_plots_from_training_and_push('numerical_experiments/Part4_architectures/pmnn_ResNet_2D_d2_w20')
    generate_plots_from_training_and_push('numerical_experiments/Part4_architectures/pmnn_ResNet_2D_d2_w40')
